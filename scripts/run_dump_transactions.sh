#!/bin/bash
#
# Run the dump_transactions_to_metrics.py script from a k8s pod.
#
# Usage:
#   ./run_dump_transactions.sh <namespace> [options]
#
# Examples:
#   # Dry run on staging
#   ./run_dump_transactions.sh studio-stg --dry-run
#
#   # Process all transactions on production
#   ./run_dump_transactions.sh studio-prd \
#       --api-url "https://your-metrics-api.com" \
#       --api-key "your-api-key"
#
#   # Process all transactions before a specific hash (exclusive)
#   ./run_dump_transactions.sh studio-prd \
#       --api-url "https://your-metrics-api.com" \
#       --api-key "your-api-key" \
#       --until-hash "0xabc123..."
...
PYTHON_SCRIPT="$SCRIPT_DIR/dump_transactions_to_metrics.py"
POD_NAME="dump-transactions-pod"
...
kubectl delete configmap dump-transactions-script --ignore-not-found >/dev/null 2>&1 || true
kubectl create configmap dump-transactions-script --from-file=script.py="$PYTHON_SCRIPT"
