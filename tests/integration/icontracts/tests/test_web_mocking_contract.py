...
import pytest
import json
from gltest import get_contract_factory, DeploymentError, Contract
...
def test_error_web_with_mocking(setup_validators):
    ...
    setup_validators(mock_response=mock_llm_response, mock_web_responses=mock_web_responses)
    ...
    contract3 = factory.deploy(args=[2, "https://this-domain-definitely-does-not-exist-12345.com"])
