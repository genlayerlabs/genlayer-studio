...
def main():
    ...
    try:
        ...
        if 'result' in tx_data:
            ...
            if 'to_address' in raw_tx and raw_tx['to_address'] != '0x0000000000000000000000000000000000000000':
                contract_address = raw_tx['to_address']
            elif 'recipient' in raw_tx and raw_tx['recipient'] != '0x0000000000000000000000000000000000000000':
    ...
    try:
        schema_response = requests.post('http://localhost:4000/api', json={
            "jsonrpc": "2.0",
        ...
        if 'result' in schema_result:
            ...
            if 'result' in schema_result:
                ...
                print(f"Error: {schema_result.get('error', {}).get('message', 'Unknown error')}")
    ...
    try:
        ...
        if post_sim_state == initial_state:
            print("✅ SUCCESS: State unchanged - simulation didn't modify contract state!")
        else:
            print(f"⚠️  State changed from {initial_state} to {post_sim_state} during simulation")
