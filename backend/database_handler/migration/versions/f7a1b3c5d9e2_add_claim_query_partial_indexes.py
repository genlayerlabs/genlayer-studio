...
def upgrade() -> None:
    ...
    op.execute(
        """
        CREATE INDEX IF NOT EXISTS idx_transactions_pending_finalization
    ...
    op.execute(
        """
        CREATE INDEX IF NOT EXISTS idx_transactions_pending_appeal
        ON transactions (created_at)
        WHERE appealed = true
    ...
    op.execute(
        """
        CREATE INDEX IF NOT EXISTS idx_transactions_pending_claim
    ...
    op.execute(
        """
        CREATE INDEX IF NOT EXISTS idx_transactions_active_block
