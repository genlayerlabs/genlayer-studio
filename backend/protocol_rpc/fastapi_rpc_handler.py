...
from backend.protocol_rpc.fastapi_endpoint_generator import (
    register_endpoints_for_fastapi,
    FastAPIEndpointRegistry,
)

# Import the common JSONRPCError exception
...
class RPCHandler:
    ...
    def _initialize_registry(self):
        ...
        self.registry = register_endpoints_for_fastapi(
            ...
            modifiable_validators_registry=self.app_state.get(
    ...
    async def handle_request(
        ...
        try:
            ...
            result = await self.registry.handle_method(
                request.method, request.params, app_state, db
            )
